   ...
   public String  palabraADescubrir;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i=0; i < longitudPalabra;i++){
            System.out.println("caracter "+ palabraADescubrir.charAt(i)); 
        }  
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(contieneLetra==true){    
             System.out.println("La letra "+letraAdivinar +" esta en la palabra");
             jTextPane1.setText(jTextPane1.getText()+"\n "+letraAdivinar +" si esta");
             System.out.println("Vidas restantes: "+vidasRestantes);
           
        }else{
            System.out.println("La letra "+letraAdivinar +" no esta en la palabra");
